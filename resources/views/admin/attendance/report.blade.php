              ...
              <form method="get" action="">
                <div class="card-body">
                  <div class="row">
                   ...
                   <input type="text" placeholder="Student ID" class="form-control" value="{{ Request::get('student_id')}}"  name="student_id">
                  </div>

                  <div class="form-group col-md-2" >
                    <label>Student Name</label>
                   <input type="text" placeholder="Student Name" class="form-control" value="{{ Request::get('student_name')}}"  name="student_name">
                  </div>
                  <div class="form-group col-md-2" >
                    <label>Student Last Name</label>
                   <input type="text" placeholder="Student Last Name" class="form-control" value="{{ Request::get('student_last_name')}}"  name="student_last_name">
                  </div>
