                ...
                <div class="card-body">
                  ...
                  <div class="form-group" col-md-3 style="margin-left: 10px;">
                    ...
                    <select class="form-control" name="type" >
                      ...
                      <option {{(Request::get('type')== 'Classroom')? 'selected': ''}} value="Classroom">Classroom</option>
                      <option {{(Request::get('type')== 'Playground')? 'selected': ''}} value="Playground">Playground</option>
                    </select>
                  </div>
