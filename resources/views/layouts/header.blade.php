...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <span class="brand-text font-weight-bold" style="font-size: 30px;">Eurokids</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @if(Auth::user()->user_type == 1)
                    ...
                    <!-- Admin, Teacher, Student, Parent Lists -->
                    <li class="nav-item">
                    ...
                    <!-- Attendance -->
                    <li class="nav-item @if(Request::segment(2) == 'attendance' || Request::segment(2) == 'report') menu-is-opening menu-open @endif">
                    ...
                    <!-- Report -->
                    <li class="nav-item @if(Request::segment(2) == 'report') menu-is-opening menu-open @endif">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ url('admin/report/student') }}" class="nav-link @if(Request::segment(3) == 'student') active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Student Report</p>
                                </a>
                            </li>
        ...
        <li class="nav-item">
            <a href="{{ url('admin/report/teacher') }}" class="nav-link @if(Request::segment(3) == 'teacher') active @endif">
                <i class="far fa-circle nav-icon"></i>
                <p>Teacher Report</p>
            </a>
        </li>
                           ...
                           <li class="nav-item">
            <a href="{{ url('admin/report/parent') }}" class="nav-link @if(Request::segment(3) == 'parent') active @endif">
                <i class="far fa-circle nav-icon"></i>
                <p>Parent Report</p>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a href="{{ url('admin/report/class') }}" class="nav-link @if(Request::segment(3) == 'class') active @endif">
                <i class="far fa-circle nav-icon"></i>
                <p>Class Report</p>
            </a>
        </li>
         <li class="nav-item">
            <a href="{{ url('admin/report/subject') }}" class="nav-link @if(Request::segment(3) == 'subject') active @endif">
                <i class="far fa-circle nav-icon"></i>
                <p>Subject Report</p>
            </a>
        </li>
